...
class SignUpForm(UserCreationForm):
    ...
    # default fields of "UserCreationForm" to be initialized
    # ======================================================
    ...
    # "clean_email" segment reference: How can i avoid a user from registering an already used email in django?
    def clean_email(self):
        if User.objects.filter(email=self.cleaned_data['email']).exists():
            # raise forms.ValidationError("the given email is already registered")
            raise forms.ValidationError("The given email already exists.")
